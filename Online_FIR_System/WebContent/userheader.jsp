...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="UserpropartyServlate"><b>${fname}
				${lname}</b></a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="SearchCriminalDetail.jsp"> <i
						class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text">Criminal
							Details</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="Missing_Record.jsp">
						<i class="fa fa-fw fa-file"></i> <span class="nav-link-text">Missing
							Report</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="Theft_Record.jsp">
						<i class="fa fa-fw fa-file"></i> <span class="nav-link-text">Theft
							Report</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="FIR_Record.jsp">
						<i class="fa fa-fw fa-file"></i> <span class="nav-link-text">FIR
							Report</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Components"><a
					...
					href="#collapseComponents" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-table"></i> <span class="nav-link-text">View
							Registered Report</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseComponents">
						<li><a href="Missing_Search.jsp">Missing Record</a></li>
						<li><a href="Theft_Search.jsp">Theft Report</a></li>
						<li><a href="FIR_Search.jsp">FIR Report</a></li>
					</ul></li>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="#collapseExamplePages" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-wrench"></i> <span class="nav-link-text">Update/Delete
							Report </span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseExamplePages">
						<li><a href="MissingReportSearchByID.jsp">Missing Report</a></li>
						<li><a href="TheftRecordSearchByID.jsp">Theft Report</a></li>
						<li><a href="FIRRecordSearchByID.jsp">FIR Report</a></li>
					</ul></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Menu Levels"><a
					class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
					href="#collapseMulti" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-area-chart"></i> <span class="nav-link-text">Complain
							Status</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseMulti">
						<li><a href="ViewMissingComplainStatusUser.jsp">Missing
								Complain Status</a></li>
						<li><a href="ViewTheftComplainStatusUser.jsp">Theft
								Complain Status</a></li>
						<li><a href="ViewFIRComplainStatusUser.jsp">FIR Complain
								Status</a></li>

					</ul></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="ChangePassword.jsp">
						<i class="fa fa-fw fa-sitemap"></i> <span class="nav-link-text">Change
							Password</span>
				</a></li>
				<!-- li class="nav-item" data-toggle="tooltip" data-placement="right"
