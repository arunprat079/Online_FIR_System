...
<title>Message FIR Complain Status</title>
</head>
<body>
	...
	<div class="container">
		<div class="card card-register mx-auto mt-5">
			<div class="card-header">FIR Complain Status</div>
			<div class="card-body">
				<form action="FIRComplainStatusUserServalate" method="post">
						...
						<div class="form-row">
							<div class="col-md-6">
								<label for="exampleInputName">Theft Complain No.:</label> <input
									...
									placeholder="Enter FIR Complain No." required="Required">
							</div>
						</div>
					</div>
