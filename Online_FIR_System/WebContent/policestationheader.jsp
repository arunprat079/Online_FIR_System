...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="UserpropartyPoliceServlate"><b>${fname}
				${lname}</b></a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="CriminalDetail.jsp"> <i class="fa fa-fw fa-dashboard"></i>
						<span class="nav-link-text">Add Criminal Detail</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link"
					href="ViewCriminalDetail.jsp"> <i class="fa fa-fw fa-table"></i>
						<span class="nav-link-text">View Criminal Detail</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Components"><a
					...
					href="#collapseComponents" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-table"></i> <span class="nav-link-text">View
							Complain Report</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseComponents">
						<li><a href="SearchMissingForPolice.jsp">Missing Complain</a></li>
						<li><a href="SearchTheftForPolice.jsp">Theft Complain</a></li>
						<li><a href="SearchFIRForPolice.jsp">FIR Complain</a></li>
					</ul></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Example Pages"><a
					class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
					href="#collapseExamplePages" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-file"></i> <span class="nav-link-text">Send
							Complain Status</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseExamplePages">
						<li><a href="MissingComplainStatus.jsp">Missing Complain
								Status</a></li>
						<li><a href="TheftComplainStatus.jsp">Theft Complain
								Status</a></li>
						<li><a href="FIRComplainStatus.jsp">FIR Complain Status</a></li>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					<ul class="sidenav-second-level collapse" id="collapseMulti">
						<li><a href="ViewMissingComplainStatus.jsp">Missing
								Complain Status</a></li>
						<li><a href="ViewTheftComplainStatus.jsp">Theft Complain
								Status</a></li>
						<li><a href="ViewFIRComplainStatus.jsp">FIR Complain
								Status</a></li>
					</ul></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link"
					href="ChangePasswordPolice.jsp"> <i class="fa fa-fw fa-wrench"></i>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<!-- Breadcrumbs-->
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="policestation.jsp">Home</a></li>
