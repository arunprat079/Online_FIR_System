...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="UserpropartyAdminServlate"><b>${fname}
				${lname}</b></a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="CriminalDetailAdmin.jsp"> <i
						class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text">Add
							Criminal Record</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link"
					href="PoliceStationRecord.jsp"> <i class="fa fa-fw fa-file"></i>
						<span class="nav-link-text">Add PoliceStation</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="AdminRecord.jsp">
						<i class="fa fa-fw fa-file"></i> <span class="nav-link-text">Add
							Admin</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link"
					href="ViewCriminalDetailAdmin.jsp"> <i
						class="fa fa-fw fa-table"></i> <span class="nav-link-text">View
							Criminal Record</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link"
					href="ViewRagisterRecordAdmin.jsp"> <i
						class="fa fa-fw fa-table"></i> <span class="nav-link-text">View
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="#collapseComponents" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-wrench"></i> <span class="nav-link-text">View
							Complain Record</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseComponents">
						<li><a href="SearchMissingForAdmin.jsp">Missing Complain
								Record</a></li>
						<li><a href="SearchTheftRecordAdmin.jsp">Theft Complain
								Record</a></li>
						<li><a href="SearchFIRRecordAdmin.jsp">FIR Complain
								Record</a></li>
					</ul></li>

				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link"
					href="ViewMissingStatusAdmin.jsp"> <i
						class="fa fa-fw fa-wrench"></i> <span class="nav-link-text">View
							Complain Status</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link"
					href="ChangePasswordAdmin.jsp"> <i class="fa fa-fw fa-sitemap"></i>
