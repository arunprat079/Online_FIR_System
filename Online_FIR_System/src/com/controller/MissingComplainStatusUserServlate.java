...
@WebServlet("/MissingComplainStatusUserServlate")
public class MissingComplainStatusUserServlate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    m=bl.searchmissingidstatususer(missingNo1);
	   
	    s.setMissingrecord(m);
	    s.setUsertype(usertype);
	    s.setStatus(status);
	    
	    bl.savemissingstatususer(s);
